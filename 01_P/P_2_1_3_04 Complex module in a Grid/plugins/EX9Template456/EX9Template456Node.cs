...
namespace VVVV.Nodes
{
	...
	#region PluginInfo
	[PluginInfo(Name = "Template456", Category = "EX9", Help = "Basic template which renders directly into the vvvv Renderer(EX9)", Tags = "")]
	#endregion PluginInfo
	public class EX9Template456Node : DXLayerOutPluginBase<CustomDeviceData>, IPluginEvaluate
	{
		#region fields & pins
		...
		public EX9Template456Node(IPluginHost host) : base(host, true, true)
		{
		}
